...
Image {
    ...
    source: {
        ...
        if ([Directories.documents, Directories.downloads, Directories.music, Directories.pictures, Directories.videos].some(dir => Files.trimFileProtocol(dir) === fileModelData.filePath))
